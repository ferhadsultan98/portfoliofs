  ...
  const handleUserSubmit = async (e) => {
    ...
    if (userInfo.name.trim() && userInfo.email.trim()) {
      ...
      if (snapshot.exists()) {
        ...
        initialMessages = [
          {
            text: `Hello, ${userInfo.name}! Hello Ali, my name is Farhad Sultan, and I am a Frontend Developer. I specialize in creating user-friendly websites using HTML, CSS, and JavaScript. How can I assist you today?`,
            sender: "system",
