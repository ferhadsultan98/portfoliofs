...
// Custom hook to handle typewriter effect for a single message
const useMessageTypewriter = (message) => {
  const typedText = useTypewriter(
    message.sender === "system" ? message.text : "",
    { speed: 50 }
  );
  return message.sender === "system" ? typedText : message.text;
};
          ...
          <>
            <div className="chatMessages">
              {messages.map((message, index) => {
                const typedText = useMessageTypewriter(message);
                return (
