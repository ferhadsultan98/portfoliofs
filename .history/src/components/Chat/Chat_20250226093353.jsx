...
const Chat = () => {
  ...
  // Store typewriter instances in a ref to manage them properly
  ...
  // Initialize typewriter instances when messages change
  useEffect(() => {
    typewriterRefs.current = messages.map((message) =>
            ...
            <div className="chatMessages">
              {messages.map((message, index) => (
                <div key={index} className={`chatMessage ${message.sender}`}>
                  <p>{typewriterRefs.current[index]}</p>
