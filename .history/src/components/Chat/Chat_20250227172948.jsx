...
import <ChatNotificatioAudion></ChatNotificatioAudion> from "../../assets/song/notfctn.mp3";
...
const Chat = () => {
  ...
  const audioRef = useRef(new Audio(ChatNotificatioAudion)); // Audio ref for playing sound
  ...
  // Play notification sound 10 seconds after component mounts
  useEffect(() => {
