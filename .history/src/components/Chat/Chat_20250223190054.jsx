...
const Chat = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    if (atIndex !== -1 && !value.includes(".", atIndex)) {
      // @ yazıldıysa ve henüz nokta yoksa, ilk öneriyi ekle
      value = `${value}${allowedDomains[0].slice(value.length - atIndex - 1)}`;
    }
          ...
          {!isAuthenticated ? (
            <form onSubmit={handleUserSubmit} className="userInfoForm">
              ...
              <input
                ...
                required
                maxLength=""
                list="email-domains" // Otomatik tamamlama önerileri için
              />
