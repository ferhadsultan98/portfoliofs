...
const Projects = () => {
  ...
  return (
    <div className="ProjeContainer" id="projects" style={{ paddingTop: "80px" }} data-aos="zoom-in" data-aos-delay="90">
      <h1>Projects</h1>
      ...
      <div className="card-container">
        {cards && cards.length > 0 ? (  
          cards.map((card, index) => (
            <div className="card" key={index} onClick={() => openModal(card)} data-aos-delay={(index + 1) * 10}>
