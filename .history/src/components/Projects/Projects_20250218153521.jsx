...
Modal.setAppElement('#root'); // This is required for accessibility (prevents screen readers from reading behind the modal)
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        closeTimeoutMS={500} // Set timeout for the modal closing transition
      >
        {modalContent && (
          <div>
