...
const Header = () => {
  ...
  const scrollToSection = (sectionId) => {
    ...
    // Menü öğesi seçildiğinde header'ı yukarı kaydır
    setTimeout(() => {
      window.scrollTo({ top: 0, behavior: "smooth" });
      setIsHeaderVisible(true); // Header'ı görünür yap
    }, 300); // Kısa bir gecikme ekleyerek scroll işleminin tamamlanmasını bekliyoruz
