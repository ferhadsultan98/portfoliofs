...
const AdminLogin = ({ setIsAuthenticated }) => {
  ...
  const loginHandle = (e) => {
    ...
    if (login === "farhad" && password === "farxad14") {
      ...
      // Eğer daha önce giriş yapılmışsa, eski kullanıcıyı çıkart
      if (localStorage.getItem("isAuthenticated") === "true") {
        // Eski oturumu sonlandır
        localStorage.removeItem("isAuthenticated");
        toast.info("Eski oturum sonlandırıldı.");
      }

      setLogin("");
      setPassword("");

      // LocalStorage'da kimlik doğrulama bilgisini kaydet
      ...
      setTimeout(() => toast.success("Müvəffəqiyyətlə daxil oldunuz", { position: "top-right" }), 500);
