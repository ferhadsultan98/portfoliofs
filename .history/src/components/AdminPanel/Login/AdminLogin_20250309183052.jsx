...
import { loginUser } from "../../../firebase/Firebase"; // firebase.js dosyasını import et
...
const AdminLogin = ({ setIsAuthenticated }) => {
  ...
  const loginHandle = async (e) => {
    ...
    try {
      ...
      setTimeout(() => toast.success("Succesfully logged!", { position: "top-right" }), 500);
      setTimeout(() => {
        navigate("/admin/admin-main");
      }, 1000);
    } catch (error) {
      console.error("Giriş hatası:", error.message);
      setTimeout(() => toast.error( "Giriş başarısız!", { position: "top-right" }), 500);
    }
  };
