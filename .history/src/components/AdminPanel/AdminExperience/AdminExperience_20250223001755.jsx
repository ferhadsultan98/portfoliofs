...
const AdminExperience = () => {
  ...
  const handleDelete = (id) => {
    ...
    remove(experienceRef)
      ...
      .catch((error) => {
        toast.error("Delete failed: ", error, { position: "top-center",  style: {
          background: 'none',
  ...
  const handleSaveEdit = async (id) => {
    ...
    if (image) {
      ...
      if (!newCompanyLogo) {
        toast.error("Image upload failed. Please try again.", { position: "top-center",  style: {
          background: 'none',
          border: '1px solid #5a1d60',
          borderRadius: '15px',
          color: '#5a1d60',
    ...
    update(experienceRef, {
      ...
      .catch((error) => {
        ...
        toast.error("Update failed: ", error, { position: "top-center",  style: {
          background: 'none',
          border: '1px solid #5a1d60',
          borderRadius: '15px',
          color: '#5a1d60',
