...
import { database, getDatabase, ref, get, remove, update } from "../../../firebase/Firebase";
...
export default function AdminExperience() {
  ...
  const [editFormData, setEditFormData] = useState({
    ...
    location: "",
    year: "",
    companyLogo: "", // Field for the image URL
  });
  const [image, setImage] = useState(null); // Image state for upload

  // Cloudinary configuration
  const cloudinaryPreset = "your_upload_preset"; // Replace with your Cloudinary preset
  const cloudinaryCloudName = "dbiltdpxh"; // Replace with your Cloudinary cloud name
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      setImage(file); // Set selected file to state
    }
  };
  ...
  const uploadImageToCloudinary = async (file) => {
    ...
    try {
      ...
      return res.data.secure_url; // Get the secure image URL
    } catch (error) {
