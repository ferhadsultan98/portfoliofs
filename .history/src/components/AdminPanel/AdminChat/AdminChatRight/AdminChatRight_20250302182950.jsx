...
export default function AdminChatRight({ selectedUser }) {
  ...
  <button
    onClick={() => handleQuickReply("Salam, sizə necə kömək edə bilərəm?")}
    className="quickReplyButton"
  >
    Salam
  </button>
  <button
    onClick={() => handleQuickReply("Sualınızı biraz daha ətraflı izah edə bilərsinizmi?")}
    className="quickReplyButton"
  >
    Ətraflı
  </button>
  <button
    onClick={() => handleQuickReply("Dərhal yoxlayıram, bir saniyə gözləyin zəhmət olmasa.")}
    className="quickReplyButton"
  >
    Yoxlama
  </button>
  <button
    onClick={() => handleQuickReply("Təşəkkürlər, sizə ən qısa zamanda cavab verəcəyəm.")}
    className="quickReplyButton"
  >
    Təşəkkür
  </button>
  <button
    onClick={() => handleQuickReply("Probleminizi həll etmək üçün əlimdən gələni edəcəyəm.")}
    className="quickReplyButton"
  >
    Həll
  </button>
