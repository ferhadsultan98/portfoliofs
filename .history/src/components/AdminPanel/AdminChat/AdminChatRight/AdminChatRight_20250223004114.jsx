      ...
      {selectedUser ? (
        <>
          <div className="adminChatRightHeader">
            <h2>{selectedUser.name}
            <LordIcon 
        src="https://cdn.lordicon.com/jdgfsfzr.json" 
        trigger="hover" 
        stroke="light" 
        style={{ width: '100px', height: '100px' }}  // React'teki doğru style formatı
      />
            </h2>
          </div>
        ...
        <p>
          Choose a user to begin the conversation <FaRegSmileWink fontSize="1.4rem"/>
        </p>
      )}
    </div>
  );
