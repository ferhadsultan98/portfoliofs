...
import { FaBars } from "react-icons/fa"; // Yeni buton için ikon
...
const AdminChatLeft = ({ onUserSelect }) => {
  ...
  return (
    <>
      <button
        className={`chat-toggle ${isMenuOpen ? "open" : ""}`}
        onClick={toggleMenu}
      >
        <FaBars />
      </button>

      <div className={`adminChatLeftContainer ${isMenuOpen ? "mobile-open" : ""}`}>
