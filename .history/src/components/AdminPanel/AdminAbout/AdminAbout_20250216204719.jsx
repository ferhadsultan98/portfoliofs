...
const AdminAbout = () => {
 ...
 : <FiEdit3 />
          ...
          <div className="form-group">
            ...
            >
              {isEditing.description ? <IoIosSave />
 : <FiEdit3 />
}
            </button>
          </div>
        ...
        <h2>Contact</h2>
          <div className="form-group">
            ...
            >
              {isEditing.contact.address ? <IoIosSave />
 : <FiEdit3 />
}
            </button>
          </div>
          ...
          <div className="form-group">
            ...
            >
              {isEditing.contact.email ? <IoIosSave />
 : <FiEdit3 />
}
            </button>
          </div>
          ...
          <div className="form-group">
            ...
            >
              {isEditing.contact.phone ? <IoIosSave />
 : <FiEdit3 />
}
            </button>
          </div>
          ...
          <div className="form-group">
            ...
            {Object.keys(aboutData.socialLinks).map((platform) => (
              <div key={platform}>
                ...
                >
                  {isEditing.socialLinks[platform] ? <IoIosSave />
 : <FiEdit3 />
}
                </button>
              </div>
      ...
      <div className="form-group">
        ...
        {aboutData.tags.map((tag, index) => (
          <div key={index} className="tag-item">
            ...
            >
              {isEditing.tags[index] ? <IoIosSave />
 : <FiEdit3 />
}
            </button>
