...
const AdminAbout = () => {
  ...
  const handleTagEdit = (index) => {
    const updatedTags = [...aboutData.tags];
    updatedTags[index] = prompt("Edit Tag", updatedTags[index]);
      ...
      <div className="form-group">
        ...
        {aboutData.tags.map((tag, index) => (
          <div key={index} className="tag-item">
            ...
            {isEditing.tags && (
              <>
                <button onClick={() => handleTagDelete(index)} style={{display: 'block'}}>Delete</button>
                <button onClick={() => handleTagEdit(index)}>Edit</button>
              </>
            )}
          </div>
        ))}
