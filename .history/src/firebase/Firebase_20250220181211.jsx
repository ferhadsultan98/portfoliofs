...
import { getFirestore, collection, query, where, getDocs,  addDoc  } from "firebase/firestore"; // Firestore-ı əlavə et
...
const firestore = getFirestore(app); // Firestore-u əldə et

// Firestore funksiyalarını ixrac et
export { getDatabase, database, ref, set, get, child, remove, update, firestore, collection, query, where, getDocs,  addDoc  };
