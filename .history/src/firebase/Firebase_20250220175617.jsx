...
import { db, getFirestore, collection, query, where, getDocs } from "firebase/firestore"; 
...
export { db, getDatabase, database, ref, set, get, child, remove, update, firestore, collection, query, where, getDocs };
